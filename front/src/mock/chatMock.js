      ...
      messages: [
        {
          ...
          body: "I can see what you are doing right now haha",
          contentType: "text",
        ...
        },
        {
          ...
          body: "Did you really code all of this by yourself?",
          contentType: "text",
        ...
        {
          id: "5e867f28a34d45ac6eb5c412",
          body:
            "Of course not, come on... I'm a developer after all. I don't create something new unless I get paid.",
          contentType: "text",
      ...
      messages: [
        {
          ...
          body: "Hey, why did the chicken cross the road?",
          contentType: "text",
        ...
        },
        {
          ...
          body: "Sorry, I can't speak right now",
          contentType: "text",
          createdAt: moment().subtract(5, "minutes").toDate().getTime(),
          senderId: "5e86809283e28b96d2d38537",
        },
...
mock.onPost("/api/chat/messages/new").reply((request) => {
  ...
  const otherUser = db.contacts.find(
    (contact) => contact.username === threadKey
  );
...
mock.onPost("/api/chat/messages/delete").reply((request) => {
  const { threadKey, messageId } = JSON.parse(request.data);

  let thread = db.threads.find((_thread) => _thread.key === threadKey);

  let afterDelete = _.filter(thread.messages, function (x) {
