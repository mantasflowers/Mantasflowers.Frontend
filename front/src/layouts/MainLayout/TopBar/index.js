...
import { AppBar, Box, Hidden, IconButton, Toolbar, makeStyles, SvgIcon, Button, Typography } from '@material-ui/core';
			...
			<Toolbar className={classes.toolbar}>
				...
				<Box ml={2} flexGrow={1}>
					{account.user === null ? (
						...
						<Box style={{ display: 'flex' }}>
							<Link style={{ textDecoration: 'none', zIndex: 1 }} to="/profile-edit">
								<Button
